...
description: 缤果学伴（BingoMate）完整智能教辅闭环。用《2026 初中53同步》英语九年级 Unit 1–2 完成学生建档与摸底画像、A/B/C 内部策略判定、按画像生成个性化学习任务、记录真实作答、生成学生/家长/教师三类学习报告，并把本次观测自动合并回画像。当用户说“我要学习53”“开始学英语”“先摸个底”“给我安排今天的练习”“根据学情出题”“继续上一轮”“今天学完了”“生成学习报告”“同步给家长”，或需要在类似 OpenClaw 的平台演示从画像到任务再到报告的端到端流程时使用。也用于接入已有画像、任务包或作答记录后从对应阶段继续。本 skill 自包含题库和脚本，不依赖另外三个 BingoMate skill。
---
